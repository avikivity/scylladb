...
db::config::config(std::shared_ptr<db::extensions> exts)
    ...
    , max_partition_keys_per_query(this, "max_partition_keys_per_query", liveness::LiveUpdate, value_status::Used, 100,
            "Maximum number of distinct partition keys per query. This limit places a bound on the size of IN tuples, "
    ...
    , max_clustering_keys_per_query(this, "max_clustering_keys_per_query", liveness::LiveUpdate, value_status::Used, 100,
            "Maximum number of distinct clustering keys per query. This limit places a bound on the size of IN tuples, "
