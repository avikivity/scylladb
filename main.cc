...
class stop_signal {
    ...
    sharded<abort_source, plain_sharded_traits<abort_source>> _abort_sources;
    //future<> _broadcasts_to_abort_sources_done = broadcast_loop();
...
private:
    void signaled() {
        ...
        _broadcasts_to_abort_sources_done = _broadcasts_to_abort_sources_done.then([this] {
            startlog.info("broadcasting abort");
...
public:
    ...
    sharded<abort_source, plain_sharded_traits<abort_source>>& as_sharded_abort_source() { return _abort_sources; }
};
