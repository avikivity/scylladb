...
void init_storage_service(distributed<database>& db, sharded<gms::gossiper>& gossiper, sharded<auth::service>& auth_service,
        sharded<cql3::cql_config>& cql_config,
        sharded<db::system_distributed_keyspace>& sys_dist_ks,
        sharded<db::view::view_update_generator>& view_update_generator, sharded<gms::feature_service>& feature_service) {
    service::init_storage_service(db, gossiper, auth_service, cql_config, sys_dist_ks, view_update_generator, feature_service).get();
