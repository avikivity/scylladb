...
public:
    cql_config_updater(cql3::cql_config& cql_config, const db::config& cfg)
        ...
        tie(_cql_config.restrictions.partition_key_restrictions_max_cartesian_product_size, _cfg.max_partition_keys_per_query);
        tie(_cql_config.restrictions.clustering_key_restrictions_max_cartesian_product_size, _cfg.max_clustering_keys_per_query);
    }
};
