...
public:
    ...
    */
    ...
    public:
         ...
         */
        virtual ::shared_ptr<operation> prepare(database& db, const sstring& keyspace, const schema& schema, const column_definition& receiver) const = 0;
    ...
    public:
        ...
        virtual shared_ptr<operation> prepare(database& db, const sstring& keyspace, const schema& schema, const column_definition& receiver) const override;
