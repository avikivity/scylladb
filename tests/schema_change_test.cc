...
SEASTAR_TEST_CASE(test_schema_digest_does_not_change) {
    ...
    return test_schema_digest_does_not_change_with_disabled_features("./tests/sstables/schema_digest_test", std::set<sstring>{"COMPUTED_COLUMNS", "CDC"}, std::move(expected_digests));
}
...
SEASTAR_TEST_CASE(test_schema_digest_does_not_change_after_computed_columns) {
    ...
    return test_schema_digest_does_not_change_with_disabled_features("./tests/sstables/schema_digest_test_computed_columns", std::set<sstring>{"CDC"}, std::move(expected_digests));
}
