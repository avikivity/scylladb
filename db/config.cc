...
#define str(x)  #x
#define _mk_init(name, type, deflt, status, desc, ...)  , name(this, str(name), #type, value_status::status, type(deflt), desc)

db::config::config(std::shared_ptr<db::extensions> exts)
    : utils::config_file()

    , background_writer_scheduling_quota(this, "background_writer_scheduling_quota", "double", value_status::Unused, 1.0,
    ...
    , auto_adjust_flush_quota(this, "auto_adjust_flush_quota", "bool", value_status::Unused, false,
        "true: auto-adjust memtable shares for flush processes")
    , memtable_flush_static_shares(this, "memtable_flush_static_shares", "float", value_status::Used, 0,
    ...
    , compaction_static_shares(this, "compaction_static_shares", "float", value_status::Used, 0,
        "If set to higher than 0, ignore the controller's output and set the compaction shares statically. Do not set this unless you know what you are doing and suspect a problem in the controller. This option will be retired when the controller reaches more maturity")
    , compaction_enforce_min_threshold(this, "compaction_enforce_min_threshold", "bool", value_status::Used, false,
        "If set to true, enforce the min_threshold option for compactions strictly. If false (default), Scylla may decide to compact even if below min_threshold")
    /* Initialization properties */
    /* The minimal properties needed for configuring a cluster. */
    , cluster_name(this, "cluster_name", "sstring", value_status::Used, "",
    ...
    , listen_address(this, "listen_address", "sstring", value_status::Used, "localhost",
    ...
    , listen_interface(this, "listen_interface", "sstring", value_status::Unused, "eth0",
    ...
    , commitlog_directory(this, "commitlog_directory", "sstring", value_status::Used, "/var/lib/scylla/commitlog",
    ...
    , data_file_directories(this, "data_file_directories", "string_list", value_status::Used, { "/var/lib/scylla/data" },
        "The directory location where table data (SSTables) is stored")
    , hints_directory(this, "hints_directory", "sstring", value_status::Used, "/var/lib/scylla/hints",
        "The directory where hints files are stored if hinted handoff is enabled.")
    , view_hints_directory(this, "view_hints_directory", "sstring", value_status::Used, "/var/lib/scylla/view_hints",
        "The directory where materialized-view updates are stored while a view replica is unreachable.")
    , saved_caches_directory(this, "saved_caches_directory", "sstring", value_status::Unused, "/var/lib/scylla/saved_caches",
    ...
    , commit_failure_policy(this, "commit_failure_policy", "sstring", value_status::Unused, "stop",
    ...
    , disk_failure_policy(this, "disk_failure_policy", "sstring", value_status::Unused, "stop",
    ...
    , endpoint_snitch(this, "endpoint_snitch", "sstring", value_status::Used, "org.apache.cassandra.locator.SimpleSnitch",
    ...
    , rpc_address(this, "rpc_address", "sstring", value_status::Used, "localhost",
    ...
    , rpc_interface(this, "rpc_interface", "sstring", value_status::Unused, "eth1",
    ...
    , seed_provider(this, "seed_provider", "seed_provider_type", value_status::Used, seed_provider_type("org.apache.cassandra.locator.SimpleSeedProvider"),
    ...
    , compaction_throughput_mb_per_sec(this, "compaction_throughput_mb_per_sec", "uint32_t", value_status::Unused, 16,
    ...
    , compaction_large_partition_warning_threshold_mb(this, "compaction_large_partition_warning_threshold_mb", "uint32_t", value_status::Used, 1000,
        "Log a warning when writing partitions larger than this value")
    , compaction_large_row_warning_threshold_mb(this, "compaction_large_row_warning_threshold_mb", "uint32_t", value_status::Used, 10,
        "Log a warning when writing rows larger than this value")
    , compaction_large_cell_warning_threshold_mb(this, "compaction_large_cell_warning_threshold_mb", "uint32_t", value_status::Used, 1,
        "Log a warning when writing cells larger than this value")
    /* Common memtable settings */
    , memtable_total_space_in_mb(this, "memtable_total_space_in_mb", "uint32_t", value_status::Invalid, 0,
    ...
    , concurrent_reads(this, "concurrent_reads", "uint32_t", value_status::Invalid, 32,
    ...
    , concurrent_writes(this, "concurrent_writes", "uint32_t", value_status::Invalid, 32,
    ...
    , concurrent_counter_writes(this, "concurrent_counter_writes", "uint32_t", value_status::Unused, 32,
    ...
    , incremental_backups(this, "incremental_backups", "bool", value_status::Used, false,
    ...
    , snapshot_before_compaction(this, "snapshot_before_compaction", "bool", value_status::Unused, false,
    ...
    , phi_convict_threshold(this, "phi_convict_threshold", "uint32_t", value_status::Used, 8,
    ...
    /* Commit log settings */
    , commitlog_sync(this, "commitlog_sync", "sstring", value_status::Used, "periodic",
    ...
    , commitlog_segment_size_in_mb(this, "commitlog_segment_size_in_mb", "uint32_t", value_status::Used, 64,
    ...
    , commitlog_sync_period_in_ms(this, "commitlog_sync_period_in_ms", "uint32_t", value_status::Used, 10000,
        "Controls how long the system waits for other writes before performing a sync in \"periodic\" mode.")
    /* Note: does not exist on the listing page other than in above comment, wtf? */
    , commitlog_sync_batch_window_in_ms(this, "commitlog_sync_batch_window_in_ms", "uint32_t", value_status::Used, 10000,
        "Controls how long the system waits for other writes before performing a sync in \"batch\" mode.")
    , commitlog_total_space_in_mb(this, "commitlog_total_space_in_mb", "int64_t", value_status::Used, -1,
    ...
    , commitlog_reuse_segments(this, "commitlog_reuse_segments", "bool", value_status::Used, true,
    ...
    /* Compaction settings */
    /* Related information: Configuring compaction */
    , compaction_preheat_key_cache(this, "compaction_preheat_key_cache", "bool", value_status::Unused, true,
    ...
    , concurrent_compactors(this, "concurrent_compactors", "uint32_t", value_status::Invalid, 0,
    ...
    , in_memory_compaction_limit_in_mb(this, "in_memory_compaction_limit_in_mb", "uint32_t", value_status::Invalid, 64,
    ...
    , preheat_kernel_page_cache(this, "preheat_kernel_page_cache", "bool", value_status::Unused, false,
    ...
    , sstable_preemptive_open_interval_in_mb(this, "sstable_preemptive_open_interval_in_mb", "uint32_t", value_status::Unused, 50,
    ...
    , defragment_memory_on_idle(this, "defragment_memory_on_idle", "bool", value_status::Used, false, "When set to true, will defragment memory when the cpu is idle.  This reduces the amount of work Scylla performs when processing client requests.")
    /* Memtable settings */
    , memtable_allocation_type(this, "memtable_allocation_type", "sstring", value_status::Invalid, "heap_buffers",
    ...
    , memtable_cleanup_threshold(this, "memtable_cleanup_threshold", "double", value_status::Invalid, .11,
    ...
    , file_cache_size_in_mb(this, "file_cache_size_in_mb", "uint32_t", value_status::Unused, 512,
        "Total memory to use for SSTable-reading buffers.")
    , memtable_flush_queue_size(this, "memtable_flush_queue_size", "uint32_t", value_status::Unused, 4,
    ...
    , memtable_flush_writers(this, "memtable_flush_writers", "uint32_t", value_status::Invalid, 1,
    ...
    , memtable_heap_space_in_mb(this, "memtable_heap_space_in_mb", "uint32_t", value_status::Unused, 0,
    ...
    , memtable_offheap_space_in_mb(this, "memtable_offheap_space_in_mb", "uint32_t", value_status::Unused, 0,
        "See memtable_heap_space_in_mb")
    /* Cache and index settings */
    , column_index_size_in_kb(this, "column_index_size_in_kb", "uint32_t", value_status::Used, 64,
    ...
    , index_summary_capacity_in_mb(this, "index_summary_capacity_in_mb", "uint32_t", value_status::Unused, 0,
    ...
    , index_summary_resize_interval_in_minutes(this, "index_summary_resize_interval_in_minutes", "uint32_t", value_status::Unused, 60,
    ...
    , reduce_cache_capacity_to(this, "reduce_cache_capacity_to", "double", value_status::Invalid, .6,
    ...
    , reduce_cache_sizes_at(this, "reduce_cache_sizes_at", "double", value_status::Invalid, .85,
    ...
    /* Disks settings */
    , stream_throughput_outbound_megabits_per_sec(this, "stream_throughput_outbound_megabits_per_sec", "uint32_t", value_status::Unused, 400,
    ...
    , inter_dc_stream_throughput_outbound_megabits_per_sec(this, "inter_dc_stream_throughput_outbound_megabits_per_sec", "uint32_t", value_status::Unused, 0,
    ...
    , trickle_fsync(this, "trickle_fsync", "bool", value_status::Unused, false,
    ...
    , trickle_fsync_interval_in_kb(this, "trickle_fsync_interval_in_kb", "uint32_t", value_status::Unused, 10240,
    ...
    , auto_bootstrap(this, "auto_bootstrap", "bool", value_status::Used, true,
        ...
        "Related information: Initializing a multiple node cluster (single data center) and Initializing a multiple node cluster (multiple data centers).")
    , batch_size_warn_threshold_in_kb(this, "batch_size_warn_threshold_in_kb", "uint32_t", value_status::Used, 5,
    ...
    , batch_size_fail_threshold_in_kb(this, "batch_size_fail_threshold_in_kb", "uint32_t", value_status::Used, 50,
        "Fail any multiple-partition batch exceeding this value. 50kb (10x warn threshold) by default.")
    , broadcast_address(this, "broadcast_address", "sstring", value_status::Used, {/* listen_address */},
    ...
    , listen_on_broadcast_address(this, "listen_on_broadcast_address", "bool", value_status::Used, false, "When using multiple physical network interfaces, set this to true to listen on broadcast_address in addition to the listen_address, allowing nodes to communicate in both interfaces.  Ignore this property if the network configuration automatically routes between the public and private networks such as EC2."
    )
    , initial_token(this, "initial_token", "sstring", value_status::Used, {/* N/A */},
    ...
    , num_tokens(this, "num_tokens", "uint32_t", value_status::Used, 1,
    ...
    , partitioner(this, "partitioner", "sstring", value_status::Used, "org.apache.cassandra.dht.Murmur3Partitioner",
    ...
    , storage_port(this, "storage_port", "uint16_t", value_status::Used, 7000,
        "The port for inter-node communication.")
    /* Advanced automatic backup setting */
    , auto_snapshot(this, "auto_snapshot", "bool", value_status::Used, true,
    ...
    , key_cache_keys_to_save(this, "key_cache_keys_to_save", "uint32_t", value_status::Unused, 0,
        "Number of keys from the key cache to save. (0: all)")
    , key_cache_save_period(this, "key_cache_save_period", "uint32_t", value_status::Unused, 14400,
    ...
    , key_cache_size_in_mb(this, "key_cache_size_in_mb", "uint32_t", value_status::Unused, 100,
    ...
    , row_cache_keys_to_save(this, "row_cache_keys_to_save", "uint32_t", value_status::Unused, 0,
        "Number of keys from the row cache to save.")
    , row_cache_size_in_mb(this, "row_cache_size_in_mb", "uint32_t", value_status::Unused, 0,
    ...
    , row_cache_save_period(this, "row_cache_save_period", "uint32_t", value_status::Unused, 0,
        "Duration in seconds that rows are saved in cache. Caches are saved to saved_caches_directory.")
    , memory_allocator(this, "memory_allocator", "sstring", value_status::Invalid, "NativeAllocator",
    ...
    , counter_cache_size_in_mb(this, "counter_cache_size_in_mb", "uint32_t", value_status::Unused, 0,
    ...
    , counter_cache_save_period(this, "counter_cache_save_period", "uint32_t", value_status::Unused, 7200,
        "Duration after which Cassandra should save the counter cache (keys only). Caches are saved to saved_caches_directory.")
    , counter_cache_keys_to_save(this, "counter_cache_keys_to_save", "uint32_t", value_status::Unused, 0,
    ...
    , tombstone_warn_threshold(this, "tombstone_warn_threshold", "uint32_t", value_status::Unused, 1000,
        "The maximum number of tombstones a query can scan before warning.")
    , tombstone_failure_threshold(this, "tombstone_failure_threshold", "uint32_t", value_status::Unused, 100000,
        "The maximum number of tombstones a query can scan before aborting.")
    /* Network timeout settings */
    , range_request_timeout_in_ms(this, "range_request_timeout_in_ms", "uint32_t", value_status::Used, 10000,
        "The time in milliseconds that the coordinator waits for sequential or index scans to complete.")
    , read_request_timeout_in_ms(this, "read_request_timeout_in_ms", "uint32_t", value_status::Used, 5000,
        "The time that the coordinator waits for read operations to complete")
    , counter_write_request_timeout_in_ms(this, "counter_write_request_timeout_in_ms", "uint32_t", value_status::Used, 5000,
        "The time that the coordinator waits for counter writes to complete.")
    , cas_contention_timeout_in_ms(this, "cas_contention_timeout_in_ms", "uint32_t", value_status::Unused, 5000,
    ...
    , truncate_request_timeout_in_ms(this, "truncate_request_timeout_in_ms", "uint32_t", value_status::Used, 10000,
    ...
    , write_request_timeout_in_ms(this, "write_request_timeout_in_ms", "uint32_t", value_status::Used, 2000,
        "The time in milliseconds that the coordinator waits for write operations to complete.\n"
        "Related information: About hinted handoff writes")
    , request_timeout_in_ms(this, "request_timeout_in_ms", "uint32_t", value_status::Used, 10000,
        "The default timeout for other, miscellaneous operations.\n"
        "Related information: About hinted handoff writes")
    /* Inter-node settings */
    , cross_node_timeout(this, "cross_node_timeout", "bool", value_status::Unused, false,
    ...
    , internode_send_buff_size_in_bytes(this, "internode_send_buff_size_in_bytes", "uint32_t", value_status::Unused, 0,
        ...
        "\t/proc/sys/net/ipv4/tcp_wmem\n")
    , internode_recv_buff_size_in_bytes(this, "internode_recv_buff_size_in_bytes", "uint32_t", value_status::Unused, 0,
        "Sets the receiving socket buffer size in bytes for inter-node calls.")
    , internode_compression(this, "internode_compression", "sstring", value_status::Used, "none",
        ...
        "\tnone : No compression.")
    , inter_dc_tcp_nodelay(this, "inter_dc_tcp_nodelay", "bool", value_status::Used, false,
    ...
    , streaming_socket_timeout_in_ms(this, "streaming_socket_timeout_in_ms", "uint32_t", value_status::Unused, 0,
    ...
    , start_native_transport(this, "start_native_transport", "bool", value_status::Unused, true,
    ...
    , native_transport_port(this, "native_transport_port", "uint16_t", value_status::Used, 9042,
        "Port on which the CQL native transport listens for clients.")
    , native_transport_port_ssl(this, "native_transport_port_ssl", "uint16_t", value_status::Used, 9142,
        "Port on which the CQL TLS native transport listens for clients."
        "Enabling client encryption and keeping native_transport_port_ssl disabled will use encryption"
        "for native_transport_port. Setting native_transport_port_ssl to a different value"
        "from native_transport_port will use encryption for native_transport_port_ssl while"
        "keeping native_transport_port unencrypted")
    , native_transport_max_threads(this, "native_transport_max_threads", "uint32_t", value_status::Invalid, 128,
    ...
    , native_transport_max_frame_size_in_mb(this, "native_transport_max_frame_size_in_mb", "uint32_t", value_status::Unused, 256,
    ...
    , broadcast_rpc_address(this, "broadcast_rpc_address", "sstring", value_status::Used, {/* unset */},
    ...
    , rpc_port(this, "rpc_port", "uint16_t", value_status::Used, 9160,
        "Thrift port for client connections.")
    , start_rpc(this, "start_rpc", "bool", value_status::Used, true,
        "Starts the Thrift RPC server")
    , rpc_keepalive(this, "rpc_keepalive", "bool", value_status::Used, true,
        "Enable or disable keepalive on client connections (RPC or native).")
    , rpc_max_threads(this, "rpc_max_threads", "uint32_t", value_status::Invalid, 0,
    ...
    , rpc_min_threads(this, "rpc_min_threads", "uint32_t", value_status::Invalid, 16,
        "Sets the minimum thread pool size for remote procedure calls.")
    , rpc_recv_buff_size_in_bytes(this, "rpc_recv_buff_size_in_bytes", "uint32_t", value_status::Unused, 0,
        "Sets the receiving socket buffer size for remote procedure calls.")
    , rpc_send_buff_size_in_bytes(this, "rpc_send_buff_size_in_bytes", "uint32_t", value_status::Unused, 0,
        "Sets the sending socket buffer size in bytes for remote procedure calls.")
    , rpc_server_type(this, "rpc_server_type", "sstring", value_status::Unused, "sync",
    ...
    , cache_hit_rate_read_balancing(this, "cache_hit_rate_read_balancing", "bool", value_status::Used, true,
    ...
    , dynamic_snitch_badness_threshold(this, "dynamic_snitch_badness_threshold", "double", value_status::Unused, 0,
    ...
    , dynamic_snitch_reset_interval_in_ms(this, "dynamic_snitch_reset_interval_in_ms", "uint32_t", value_status::Unused, 60000,
        "Time interval in milliseconds to reset all node scores, which allows a bad node to recover.")
    , dynamic_snitch_update_interval_in_ms(this, "dynamic_snitch_update_interval_in_ms", "uint32_t", value_status::Unused, 100,
    ...
    , hinted_handoff_enabled(this, "hinted_handoff_enabled", "sstring", value_status::Used, "true",
        ...
        "Related information: About hinted handoff writes")
    , hinted_handoff_throttle_in_kb(this, "hinted_handoff_throttle_in_kb", "uint32_t", value_status::Unused, 1024,
    ...
    , max_hint_window_in_ms(this, "max_hint_window_in_ms", "uint32_t", value_status::Used, 10800000,
        ...
        "Related information: Failure detection and recovery")
    , max_hints_delivery_threads(this, "max_hints_delivery_threads", "uint32_t", value_status::Invalid, 2,
    ...
    , batchlog_replay_throttle_in_kb(this, "batchlog_replay_throttle_in_kb", "uint32_t", value_status::Unused, 1024,
    ...
    , request_scheduler(this, "request_scheduler", "sstring", value_status::Unused, "org.apache.cassandra.scheduler.NoScheduler",
    ...
    , request_scheduler_id(this, "request_scheduler_id", "sstring", value_status::Unused, {/* keyspace */},
        "An identifier on which to perform request scheduling. Currently the only valid value is keyspace. See weights.")
    , request_scheduler_options(this, "request_scheduler_options", "string_map", value_status::Unused, {/* disabled */},
    ...
    , thrift_framed_transport_size_in_mb(this, "thrift_framed_transport_size_in_mb", "uint32_t", value_status::Unused, 15,
        "Frame size (maximum field length) for Thrift. The frame is the row or part of the row the application is inserting.")
    , thrift_max_message_length_in_mb(this, "thrift_max_message_length_in_mb", "uint32_t", value_status::Used, 16,
    ...
    , authenticator(this, "authenticator", "sstring", value_status::Used, "org.apache.cassandra.auth.AllowAllAuthenticator",
    ...
    , internode_authenticator(this, "internode_authenticator", "sstring", value_status::Unused, "enabled",
    ...
    , authorizer(this, "authorizer", "sstring", value_status::Used, "org.apache.cassandra.auth.AllowAllAuthorizer",
    ...
    , role_manager(this, "role_manager", "sstring", value_status::Used, "org.apache.cassandra.auth.CassandraRoleManager",
    ...
    , permissions_validity_in_ms(this, "permissions_validity_in_ms", "uint32_t", value_status::Used, 10000,
        ...
        "Related information: Object permissions")
    , permissions_update_interval_in_ms(this, "permissions_update_interval_in_ms", "uint32_t", value_status::Used, 2000,
    ...
    , permissions_cache_max_entries(this, "permissions_cache_max_entries", "uint32_t", value_status::Used, 1000,
    ...
    , server_encryption_options(this, "server_encryption_options", "string_map", value_status::Used, {/*none*/},
    ...
    , client_encryption_options(this, "client_encryption_options", "string_map", value_status::Used, {/*none*/},
    ...
    , ssl_storage_port(this, "ssl_storage_port", "uint32_t", value_status::Used, 7001,
        "The SSL port for encrypted communication. Unused unless enabled in encryption_options.")
    , enable_in_memory_data_store(this, "enable_in_memory_data_store", "bool", value_status::Used, false, "Enable in memory mode (system tables are always persisted)")
    , enable_cache(this, "enable_cache", "bool", value_status::Used, true, "Enable cache")
    , enable_commitlog(this, "enable_commitlog", "bool", value_status::Used, true, "Enable commitlog")
    , volatile_system_keyspace_for_testing(this, "volatile_system_keyspace_for_testing", "bool", value_status::Used, false, "Don't persist system keyspace - testing only!")
    , api_port(this, "api_port", "uint16_t", value_status::Used, 10000, "Http Rest API port")
    , api_address(this, "api_address", "sstring", value_status::Used, "", "Http Rest API address")
    , api_ui_dir(this, "api_ui_dir", "sstring", value_status::Used, "swagger-ui/dist/", "The directory location of the API GUI")
    , api_doc_dir(this, "api_doc_dir", "sstring", value_status::Used, "api/api-doc/", "The API definition file directory")
    , load_balance(this, "load_balance", "sstring", value_status::Used, "none", "CQL request load balancing: 'none' or round-robin'")
    , consistent_rangemovement(this, "consistent_rangemovement", "bool", value_status::Used, true, "When set to true, range movements will be consistent. It means: 1) it will refuse to bootstrap a new node if other bootstrapping/leaving/moving nodes detected. 2) data will be streamed to a new node only from the node which is no longer responsible for the token range. Same as -Dcassandra.consistent.rangemovement in cassandra")
    , join_ring(this, "join_ring", "bool", value_status::Used, true, "When set to true, a node will join the token ring. When set to false, a node will not join the token ring. User can use nodetool join to initiate ring joinging later. Same as -Dcassandra.join_ring in cassandra.")
    , load_ring_state(this, "load_ring_state", "bool", value_status::Used, true, "When set to true, load tokens and host_ids previously saved. Same as -Dcassandra.load_ring_state in cassandra.")
    , replace_node(this, "replace_node", "sstring", value_status::Used, "", "The UUID of the node to replace. Same as -Dcassandra.replace_node in cssandra.")
    , replace_token(this, "replace_token", "sstring", value_status::Used, "", "The tokens of the node to replace. Same as -Dcassandra.replace_token in cassandra.")
    , replace_address(this, "replace_address", "sstring", value_status::Used, "", "The listen_address or broadcast_address of the dead node to replace. Same as -Dcassandra.replace_address.")
    , replace_address_first_boot(this, "replace_address_first_boot", "sstring", value_status::Used, "", "Like replace_address option, but if the node has been bootstrapped successfully it will be ignored. Same as -Dcassandra.replace_address_first_boot.")
    , override_decommission(this, "override_decommission", "bool", value_status::Used, false, "Set true to force a decommissioned node to join the cluster")
    , ring_delay_ms(this, "ring_delay_ms", "uint32_t", value_status::Used, 30 * 1000, "Time a node waits to hear from other nodes before joining the ring in milliseconds. Same as -Dcassandra.ring_delay_ms in cassandra.")
    , shadow_round_ms(this, "shadow_round_ms", "uint32_t", value_status::Used, 300 * 1000, "The maximum gossip shadow round time. Can be used to reduce the gossip feature check time during node boot up.")
    , fd_max_interval_ms(this, "fd_max_interval_ms", "uint32_t", value_status::Used, 2 * 1000, "The maximum failure_detector interval time in milliseconds. Interval larger than the maximum will be ignored. Larger cluster may need to increase the default.")
    , fd_initial_value_ms(this, "fd_initial_value_ms", "uint32_t", value_status::Used, 2 * 1000, "The initial failure_detector interval time in milliseconds.")
    , shutdown_announce_in_ms(this, "shutdown_announce_in_ms", "uint32_t", value_status::Used, 2 * 1000, "Time a node waits after sending gossip shutdown message in milliseconds. Same as -Dcassandra.shutdown_announce_in_ms in cassandra.")
    , developer_mode(this, "developer_mode", "bool", value_status::Used, false, "Relax environment checks. Setting to true can reduce performance and reliability significantly.")
    , skip_wait_for_gossip_to_settle(this, "skip_wait_for_gossip_to_settle", "int32_t", value_status::Used, -1, "An integer to configure the wait for gossip to settle. -1: wait normally, 0: do not wait at all, n: wait for at most n polls. Same as -Dcassandra.skip_wait_for_gossip_to_settle in cassandra.")
    , experimental(this, "experimental", "bool", value_status::Used, false, "Set to true to unlock experimental features.")
    , lsa_reclamation_step(this, "lsa_reclamation_step", "size_t", value_status::Used, 1, "Minimum number of segments to reclaim in a single step")
    , prometheus_port(this, "prometheus_port", "uint16_t", value_status::Used, 9180, "Prometheus port, set to zero to disable")
    , prometheus_address(this, "prometheus_address", "sstring", value_status::Used, "0.0.0.0", "Prometheus listening address")
    , prometheus_prefix(this, "prometheus_prefix", "sstring", value_status::Used, "scylla", "Set the prefix of the exported Prometheus metrics. Changing this will break Scylla's dashboard compatibility, do not change unless you know what you are doing.")
    , abort_on_lsa_bad_alloc(this, "abort_on_lsa_bad_alloc", "bool", value_status::Used, false, "Abort when allocation in LSA region fails")
    , murmur3_partitioner_ignore_msb_bits(this, "murmur3_partitioner_ignore_msb_bits", "unsigned", value_status::Used, 12, "Number of most siginificant token bits to ignore in murmur3 partitioner; increase for very large clusters")
    , virtual_dirty_soft_limit(this, "virtual_dirty_soft_limit", "double", value_status::Used, 0.6, "Soft limit of virtual dirty memory expressed as a portion of the hard limit")
    , sstable_summary_ratio(this, "sstable_summary_ratio", "double", value_status::Used, 0.0005, "Enforces that 1 byte of summary is written for every N (2000 by default) "
        "bytes written to data file. Value must be between 0 and 1.")
    , large_memory_allocation_warning_threshold(this, "large_memory_allocation_warning_threshold", "size_t", value_status::Used, size_t(1) << 20, "Warn about memory allocations above this size; set to zero to disable")
    , enable_deprecated_partitioners(this, "enable_deprecated_partitioners", "bool", value_status::Used, false, "Enable the byteordered and murmurs partitioners. These partitioners are deprecated and will be removed in a future version.")
    , enable_keyspace_column_family_metrics(this, "enable_keyspace_column_family_metrics", "bool", value_status::Used, false, "Enable per keyspace and per column family metrics reporting")
    , enable_sstable_data_integrity_check(this, "enable_sstable_data_integrity_check", "bool", value_status::Used, false, "Enable interposer which checks for integrity of every sstable write."
        " Performance is affected to some extent as a result. Useful to help debugging problems that may arise at another layers.")
    , cpu_scheduler(this, "cpu_scheduler", "bool", value_status::Used, true, "Enable cpu scheduling")
    , view_building(this, "view_building", "bool", value_status::Used, true, "Enable view building; should only be set to false when the node is experience issues due to view building")
    , enable_sstables_mc_format(this, "enable_sstables_mc_format", "bool", value_status::Used, true, "Enable SSTables 'mc' format to be used as the default file format")
    , enable_dangerous_direct_import_of_cassandra_counters(this, "enable_dangerous_direct_import_of_cassandra_counters", "bool", value_status::Used, false, "Only turn this option on if you want to import tables from Cassandra containing counters, and you are SURE that no counters in that table were created in a version earlier than Cassandra 2.1."
    ...
    , enable_shard_aware_drivers(this, "enable_shard_aware_drivers", "bool", value_status::Used, true, "Enable native transport drivers to use connection-per-shard for better performance")

    , default_log_level(this, "default_log_level", "log_level", value_status::Used)
    , logger_log_level(this, "logger_log_level", "log_level_map", value_status::Used)
    , log_to_stdout(this, "log_to_stdout", "bool", value_status::Used)
    , log_to_syslog(this, "log_to_syslog", "bool", value_status::Used)
